...
- When giving a source, cite based on the articles in your context, not on the input of the caregiver or patient
...
The two emotions the patient is currently experiencing: (write in title case)
{emotions}
